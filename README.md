...
As análises foram realizadas em ambiente Python (Google Colab), utilizando bibliotecas como Pandas, NumPy, Plotly, Seaborn e Missingno. O dashboard foi desenvolvido no Tableau Public, com versionamento no GitHub.

## Principais insights

- Forte predominância de mídias reprodutíveis, como fotografias, gravuras e materiais editoriais  
- Alta concentração do acervo em poucos departamentos, especialmente *Drawings & Prints*  
- Predominância de artistas de países do eixo ocidental, com destaque para os Estados Unidos  
